  ...
  beforeEach(inject(function (_$httpBackend_, $controller, $rootScope) {
    $httpBackend = _$httpBackend_;
	  ...
	  $httpBackend.expectGET('/api/books')
	    .respond([{id: 1, fullname: 'abcd', cnt: 2},{id: 2, fullname: 'xyz', cnt: 1}, {id: 3, fullname: 'syzygy', cnt: 1},{id: 4, fullname: 'luminiferous', cnt: 1}]);
    ...
    MainCtrl = $controller('MainCtrl', {
	  ...
	  it('should fetch some books', function () {
	  	$httpBackend.flush();
	    expect(scope.books.length).to.equal(4);
		expect(scope.displayedBooks.length).to.equal(4);
	...
	it('should send twice as many POSTs when reverseMatches is true', function(done){
		...
		scope.candidates = [
			{book1_id: 1, book2_id: 2, weight1: 85, weight2: null, matched: null, isSelected: true},
			{book1_id: 1, book2_id: 3, weight1: 87, weight2: null, matched: null},
			{book1_id: 2, book2_id: 4, weight1: 87, weight2: null, matched: null}	];
